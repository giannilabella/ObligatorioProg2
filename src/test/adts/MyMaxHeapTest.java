...
class MyMaxHeapTest {
    ...
    void testAddAllAndRemove() {
        MyHeap<Integer> otherHeap = new MyMaxHeap<>();
        assertAll(
                () -> assertTrue(heap.add(1)),
                () -> assertTrue(heap.add(2)),
    ...
    void toArray() {
        ...
        assertAll(
                ...
                () -> assertEquals(6, heap.toArray(smallArray)[0]),
                () -> assertEquals(5, heap.toArray(smallArray)[1]),
                () -> assertEquals(4, heap.toArray(rightSizedArray)[2]),
                () -> assertEquals(3, heap.toArray(rightSizedArray)[3]),
                () -> assertEquals(2, heap.toArray(bigArray)[4]),
                () -> assertEquals(1, heap.toArray(bigArray)[5])
        );
    }
}